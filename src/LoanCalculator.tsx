  ...
  return (
    <div className="loan-calculator-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* If installemtns has data input, the the table with the results will show below. Otherwise defualt is hidden */}
      {!!installments?.length && (
        <table>
          <thead>
            <tr>
          ...
          <tbody>
               {/* Installments get displayed at the bottom using this function into the table below */}
